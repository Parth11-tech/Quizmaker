...
os.environ["GOOGLE_API_KEY"] = 'AIzaSyCVAjNdQyM37DKzmnrfkSmZTFYZjj_1oCs'  # Add your API Key
...
num_questions = st.slider("How many questions do you want?", min_value=1, max_value=1500, value=5, step=1)
